...
class CadastroEntradaPage extends StatefulWidget {
  final Map<String, dynamic>? movimentacaoInicial;

  const CadastroEntradaPage({Key? key, this.movimentacaoInicial}) : super(key: key);

  @override
  _CadastroEntradaPageState createState() => _CadastroEntradaPageState();
}

class _CadastroEntradaPageState extends State<CadastroEntradaPage> {
  ...
  void _submit() {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      final movimento = {
        ...
        // entradas devem ser valores positivos
        'valor': valor.abs(),
        'tipo': 'entrada',
      };
